                        ...
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                ...
                                val productSeed = listOf(
                                    ...
                                    ProductEntity(name = "Samsung Galaxy S21", description = "Smartphone Android con cámara avanzada y rendimiento rápido.", price = 429990.0, imageUrl = R.drawable.samsung_galaxy_s21, stock = 12, sku = "SMT-SAM-004", category = "Smartphones"),
                                    ...
                                    ProductEntity(name = "iPhone 12 Reacondicionado", description = "Teléfono Apple reacondicionado con diseño premium y garantía.", price = 389990.0, imageUrl = R.drawable.iphone_12, stock = 7, sku = "SMT-APL-005", category = "Smartphones"),
                                    ...
                                    ProductEntity(name = "ASUS Prime B550M", description = "Placa madre de alta calidad para procesadores AMD Ryzen.", price = 149990.0, imageUrl = R.drawable.asus_b550m, stock = 9, sku = "CMP-MOB-012", category = "Componentes"),
                                        ...
                                        ProductEntity(name = "Sony WH-1000XM4", description = "Audífonos inalámbricos con cancelación de ruido de última generación.", price = 249990.0, imageUrl = R.drawable.sony_wh1000xm4, stock = 10, sku = "AUD-SON-014", category = "Audio"),
                                    ...
                                    ProductEntity(name = "Silla Gamer Cougar Armor", description = "Silla ergonómica con soporte ajustable para largas sesiones.", price = 199990.0, imageUrl = R.drawable.silla_cougar_armor, stock = 5, sku = "PER-COU-017", category = "Periféricos"),
